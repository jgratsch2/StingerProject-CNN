...
dataset = 'images'
model_path = 'AllStressesModel_downsample.h5'
plot = 'Accuracy_plot_downsample'
...
data2 = data[MagnesiumPotassiumDeficiency] # goal for downsample - 111
data3 = data[NitrogenDeficiency]
data4 = data[NorthernCornLeafBlight]
...
data_resampled = np.concatenate([data0_resample, data1_resample, data2,
                                 data3_resample, data4_resample, data5_resample, data6_resample], axis = 0)

label_0 = np.full((89,), 0)
label_1 = np.full((89,), 1)
label_2 = np.full((89,), 2)
label_3 = np.full((89,), 3)
label_4 = np.full((89,), 4)
label_5 = np.full((89,), 5)
label_6 = np.full((89,), 6)
